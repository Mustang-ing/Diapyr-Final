...
class Debat(models.Model):
    ...
    debat_created = models.BooleanField(default=False) # A terme, il faudrait plutôt utiliser step pour savoir si le débat est créé ou pas.
...
def check_subscription_end_date(debat: Debat) -> bool:
    """
    Check if the subscription end date is in the past.
